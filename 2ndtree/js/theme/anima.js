...
$("#b-csr").click(function(event){event.preventDefault();$("#csr").fadeIn(400);$("#epi").fadeOut(400)});
$("#b-epi").click(function(event){event.preventDefault();$("#epi").fadeIn(400);;$("#csr").fadeOut(400)});
;}); 
