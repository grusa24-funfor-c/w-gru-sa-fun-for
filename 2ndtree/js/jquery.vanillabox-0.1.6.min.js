...
function T(a,b){var d=a.f.d,e=a.f.d.c;e&&e.R&&e===b||(a.B(),B(d,b),a.V(),a.ca.a.text(b.Ha),b.load());d.C()}function W(a){var b=a.k;a.Y.a.text(String(b.i+1)+" de "+String(b.s));N(a.L,!(b.v||0<b.i));N(a.D,!(b.v||b.i<b.s-1));T(a,a.p[a.k.i])}function X(a){a.ha&&clearTimeout(a.ha);a.ha=setTimeout(function(){a.Fa&&a.m.T(a.f)},300)}c.I=function(){X(this)};c.ra=function(){X(this)};c.la=function(a){if(this.Ga)switch(a.keyCode){case 27:this.hide();break;case 37:this.M();break;case 39:this.next()}};
